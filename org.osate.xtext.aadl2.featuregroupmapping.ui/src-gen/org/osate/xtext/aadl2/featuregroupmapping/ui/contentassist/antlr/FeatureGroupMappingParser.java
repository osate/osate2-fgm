		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFGTMappingsetAccess().getGroup(), "rule__FGTMappingset__Group__0");
					put(grammarAccess.getFGTMappingsetAccess().getGroup_2(), "rule__FGTMappingset__Group_2__0");
					put(grammarAccess.getFGMSubclauseAccess().getGroup(), "rule__FGMSubclause__Group__0");
					put(grammarAccess.getFGMMappingAccess().getGroup(), "rule__FGMMapping__Group__0");
					...
					put(grammarAccess.getFGMLibraryAccess().getFgtmappingsetAssignment(), "rule__FGMLibrary__FgtmappingsetAssignment");
					put(grammarAccess.getFGTMappingsetAccess().getNameAssignment_1(), "rule__FGTMappingset__NameAssignment_1");
					put(grammarAccess.getFGTMappingsetAccess().getMappingsetAssignment_2_1(), "rule__FGTMappingset__MappingsetAssignment_2_1");
					put(grammarAccess.getFGTMappingsetAccess().getMappingAssignment_3(), "rule__FGTMappingset__MappingAssignment_3");
					put(grammarAccess.getFGMSubclauseAccess().getMappingsetAssignment_2(), "rule__FGMSubclause__MappingsetAssignment_2");
					put(grammarAccess.getFGMMappingAccess().getLeftAssignment_0(), "rule__FGMMapping__LeftAssignment_0");
					put(grammarAccess.getFGMMappingAccess().getRightAssignment_2(), "rule__FGMMapping__RightAssignment_2");
